...
class Delegation extends Sprite
{
	...
	public function new() 
	{
		...
		categories[0] = new CaseTarget(105+26.5, 105+26.5, 0);
		addChild(categories[0]);
		categories[1] = new CaseTarget(119+26.5, 45+26.5, 2);
		addChild(categories[1]);
		categories[2] = new CaseTarget(190+26.5, 30+26.5, 4);
		addChild(categories[2]);
		categories[3] = new CaseTarget(255+26.5, 45+26.5, 6);
		addChild(categories[3]);
		categories[4] = new CaseTarget(270+26.5, 105+26.5, 8);
		addChild(categories[4]);
		
		categories[5] = new ChooseCase(Lib.current.stage.stageWidth * 0.5, Lib.current.stage.stageHeight - 100 - Global.elementSize, 0);
