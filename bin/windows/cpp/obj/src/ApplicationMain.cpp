...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(22)
		::openfl::_v2::Lib_obj::setPackage(HX_CSTRING("Robert-Jan Zandvoort"),HX_CSTRING("PlatformEngine"),HX_CSTRING("PlatformEngine"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(38)
		::openfl::_v2::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)480,(int)60,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::openfl::_v2::Lib_obj::HARDWARE) | int(::openfl::_v2::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::openfl::_v2::Lib_obj::RESIZABLE))) | int(::openfl::_v2::Lib_obj::BORDERLESS))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("Platform Engine"),null(),null());
	}
return null();
}
