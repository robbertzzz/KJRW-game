...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Robert-Jan Zandvoort", "PlatformEngine", "PlatformEngine", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Platform Engine", null, { width: 640, height: 480 });
